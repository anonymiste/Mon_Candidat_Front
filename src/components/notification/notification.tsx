  ...
  return (
    <StyledWrapper>
      <div className="info" id="notification">
        ...
        <div className="info__close"><svg height={20} onClick={ () => {document.getElementById("notification")!.style.display = "none"} } viewBox="0 0 20 20" width={20} xmlns="http://www.w3.org/2000/svg"><path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#393a37" /></svg></div>
      </div>
    </StyledWrapper>
  );
}
